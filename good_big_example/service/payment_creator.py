...
from good_big_example.entities import Payment
...
class PaymentCreator:
    ...
    def new(self, order_id: int, payment_date: datetime.date, amount: float, payment_method: str) -> Payment:
        new_payment: typing.Final = Payment(
            id=0, order_id=order_id, payment_date=payment_date, amount=amount, payment_method=payment_method
        )
