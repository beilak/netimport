...
from netimport_lib.visualizer.bokeh_plotter.models.internal import PackedBoxFrame
...
from netimport_lib.visualizer.bokeh_plotter.models.render import (
    BlockScaleSpec,
    FolderLayoutBuildContext,
    LocalNodeLayoutSizing,
)
from netimport_lib.visualizer.bokeh_plotter.types import (
...
if TYPE_CHECKING:
    from netimport_lib.visualizer.bokeh_plotter.models.layout import ContainerLayout
